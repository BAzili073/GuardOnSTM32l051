...
#define INPUT_2_PORT GPIOA
#define INPUT_3_PORT GPIOA
#define INPUT_4_PORT GPIOA
#define INPUT_5_PORT GPIOA

#define INPUT_1 GPIO_PIN_0
#define INPUT_2 GPIO_PIN_5
#define INPUT_3 GPIO_PIN_4
...
#define DET_220_PIN GPIO_PIN_1
#define DET_220_CHANNEL ADC_CHANNEL_1
